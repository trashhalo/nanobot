...
class SubagentManager:
    ...
    async def spawn(
        ...
        model = self.search_model if search and self.search_model else None
    ...
    async def _run_subagent(
        ...
        try:
            ...
            tools.register(WebSearchTool(api_key=self.brave_api_key, proxy=self.web_proxy, provider=self.provider, search_model=self.search_model))
