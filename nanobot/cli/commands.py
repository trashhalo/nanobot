...
def gateway(
    ...
    agent = AgentLoop(
        ...
        web_search_options=config.agents.defaults.web_search_options,
        search_model=config.agents.defaults.search_model,
        model_fallbacks=config.agents.defaults.model_fallbacks or None,
...
def agent(
    ...
    async def _cli_progress(content: str, *, tool_hint: bool = False, final: bool = False) -> None:
